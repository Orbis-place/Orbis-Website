    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-lg border-2 border-border bg-[#06363D] shadow-xl shadow-primary/10",
          // Animations
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Base styles with Orbis colors
        "relative flex w-full cursor-default select-none items-center gap-2",
        "rounded-md py-2 pr-8 pl-3 text-sm font-nunito text-foreground",
        "outline-hidden",
