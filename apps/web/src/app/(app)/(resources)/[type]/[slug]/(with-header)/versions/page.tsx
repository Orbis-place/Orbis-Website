    ...
    const allVersions: Version[] = [
        {
            ...
            channel: 'release',
            changelog: [
                'Added new feature for enhanced gameplay',
                'Improved performance by 30%',
                'Fixed critical bug causing crashes',
                'Updated for latest Beta 2.x version',
        ...
        },
        {
            ...
            gameVersions: ['Beta 2.x'],
            fileSize: '2.4 MB',
            fileName: `${resource.slug}-2.1.0-beta.2.jar`,
            channel: 'beta',
            changelog: [
                'Testing new feature implementation',
        ...
        },
        {
            ...
            channel: 'release',
            changelog: [
                'Major update with complete redesign',
        ...
        },
        {
            ...
            date: '3 months ago',
            downloads: 8234,
            gameVersions: ['Alpha 1.x'],
            fileSize: '2.0 MB',
            fileName: `${resource.slug}-1.5.0-alpha.1.jar`,
            channel: 'alpha',
            changelog: [
